    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={{ textAlign: 'center', marginTop: 40, color: '#64748b' }}>No doctors found.</Text>}
        />
      )}
    </SafeAreaView>
  );
...
const styles = StyleSheet.create({
  ...
  timeUnread: { color: Colors.light.primary, fontWeight: '600' },
  role: { fontSize: 13, color: Colors.light.primary, marginBottom: 8 },
